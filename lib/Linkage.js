...
var LinkageItem = function LinkageItem(prop) {
  ...
  var inspect = function inspect(allFields) {
    ...
    bindfield.forEach(function (item) {
      ...
      var isbind = (0, _util.IsBindContrast)(value, item.value || '', item.mode || '');
...
var Linkage = function Linkage(props) {
  ...
  var newChildren = children.map(function (item, key) {
    ...
    if (Array.isArray(bindfield)) {
      ...
      return _react.default.cloneElement(_react.default.createElement(LinkageItem // eslint-disable-next-line react/no-array-index-key
      , {
  ...
  var param = _objectSpread(_objectSpread({}, childrenProps.props), {}, {
